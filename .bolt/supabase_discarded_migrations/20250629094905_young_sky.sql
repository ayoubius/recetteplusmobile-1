/*
  # Ajout du système de suivi de livraison

  1. Nouvelles Tables
    - `delivery_persons` - Stocke les informations sur les livreurs
    - `order_status_history` - Historique des changements de statut des commandes
    - `order_tracking` - Informations de suivi en temps réel des commandes
    - `delivery_zones` - Zones de livraison disponibles

  2. Modifications
    - Ajout de colonnes à la table `orders` pour le suivi
    - Ajout de nouvelles permissions pour les rôles spécifiques

  3. Sécurité
    - Politiques RLS pour chaque table
    - Fonctions pour la gestion des statuts de commande
*/
